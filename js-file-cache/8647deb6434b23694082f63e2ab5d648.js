...
!function (e, t) {
  ...
  var i,
    ...
    o = cc11001100_hook("o", {
      getPath: cc11001100_hook("getPath", function () {
        var t = cc11001100_hook("t", document.currentScript ? document.currentScript.src : function () {
          ...
          i = cc11001100_hook("i", e.LAYUI_GLOBAL || {}, "var-init");
      ...
      link: function (t, i, n) {
        if (r.path) {
          ...
          var l = cc11001100_hook("l", (n || t).replace(/\.|\//g, ""), "var-init"),
            ...
            c = cc11001100_hook("c", "creating", "var-init"),
            u = cc11001100_hook("u", 0, "var-init");
          s.rel = cc11001100_hook("s.rel", "stylesheet", "assign"), s.href = cc11001100_hook("s.href", r.path + t, "assign"), s.id = cc11001100_hook("s.id", f, "assign"), document.getElementById(f) || a.appendChild(s), "function" == typeof i && !function d(t) {
            var n = cc11001100_hook("n", 100, "var-init"),
              a = cc11001100_hook("a", document.getElementById(f), "var-init");
    ...
    r = cc11001100_hook("r", {
      v: cc11001100_hook("v", "3.5.1", "object-key-init"),
      ...
      tips: function (e, t, n) {
        return r.open(i.extend({
          ...
          maxWidth: cc11001100_hook("maxWidth", 260, "object-key-init")
        }, n));
      }
    }, "var-init"),
    s = function (e) {
      ...
      t.index = cc11001100_hook("t.index", ++r.index, "assign"), t.config.maxWidth = cc11001100_hook("t.config.maxWidth", i(n).width() - 30, "assign"), t.config = cc11001100_hook("t.config", i.extend({}, t.config, o.config, e), "assign"), document.body ? a() : setTimeout(function () {
        a();
      }, 30);
    };
  ...
  l.anim = cc11001100_hook("l.anim", ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], "assign"), l.SHADE = cc11001100_hook("l.SHADE", "layui-layer-shade", "assign"), l.MOVE = cc11001100_hook("l.MOVE", "layui-layer-move", "assign"), s.pt.config = cc11001100_hook("s.pt.config", {
    ...
    minStack: cc11001100_hook("minStack", !0, "object-key-init"),
    ...
    if (!t.id || !i("#" + t.id)[0]) {
      switch ("string" == typeof t.area && (t.area = cc11001100_hook("t.area", "auto" === t.area ? ["", ""] : [t.area, ""], "assign")), t.shift && (t.anim = cc11001100_hook("t.anim", t.shift, "assign")), 6 == r.ie && (t.fixed = cc11001100_hook("t.fixed", !1, "assign")), t.type) {
        case 0:
          ...
          break;
        case 2:
          var s = cc11001100_hook("s", t.content = cc11001100_hook("t.content", f ? t.content : [t.content || "", "auto"], "assign"), "var-init");
      ...
      if (e.vessel(f, function (n, r, u) {
        ...
        }() : c.append(n[1]), i("#" + l.MOVE)[0] || c.append(o.moveElem = cc11001100_hook("o.moveElem", u, "assign")), e.layero = cc11001100_hook("e.layero", i("#" + l[0] + a), "assign"), e.shadeo = cc11001100_hook("e.shadeo", i("#" + l.SHADE + a), "assign"), t.scrollbar || l.html.css("overflow", "hidden").attr("layer-full", a);
      }).auto(a), e.shadeo.css({
    ...
    t.openLayer(), a.success && (2 == a.type ? n.find("iframe").on("load", function () {
      ...
      var e = cc11001100_hook("e", a.min && a.min(n, t.index), "var-init");
      e === !1 || r.min(t.index, a);
    ...
    var a = cc11001100_hook("a", i("#" + l[0] + e), "var-init"),
      s = cc11001100_hook("s", i("#" + l.SHADE + e), "var-init"),
      f = cc11001100_hook("f", a.find(l[1]).outerHeight() || 0, "var-init"),
      c = cc11001100_hook("c", a.attr("minLeft") || 181 * o.minIndex + "px", "var-init"),
      u = cc11001100_hook("u", a.css("position"), "var-init"),
      d = cc11001100_hook("d", {
    ...
    o.record(a), o.minLeft[0] && (c = cc11001100_hook("c", o.minLeft[0], "assign"), o.minLeft.shift()), t.minStack && (d.left = cc11001100_hook("d.left", c, "assign"), d.top = cc11001100_hook("d.top", n.height() - f, "assign"), a.attr("minLeft") || o.minIndex++, a.attr("minLeft", c)), a.attr("position", u), r.style(e, d, !0), a.find(".layui-layer-min").hide(), "page" === a.attr("type") && a.find(l[4]).hide(), o.rescollbar(e), s.hide();
  }, "assign"), r.restore = cc11001100_hook("r.restore", function (e) {
    var t = cc11001100_hook("t", i("#" + l[0] + e), "var-init"),
      n = cc11001100_hook("n", i("#" + l.SHADE + e), "var-init"),
      a = cc11001100_hook("a", t.attr("area").split(","), "var-init");
    t.attr("type");
    r.style(e, {
      width: cc11001100_hook("width", parseFloat(a[0]), "object-key-init"),
      height: cc11001100_hook("height", parseFloat(a[1]), "object-key-init"),
      top: cc11001100_hook("top", parseFloat(a[2]), "object-key-init"),
      left: cc11001100_hook("left", parseFloat(a[3]), "object-key-init"),
    ...
    n.html(e);
  }, "assign"), r.close = cc11001100_hook("r.close", function (e, t) {
    var n = cc11001100_hook("n", i("#" + l[0] + e), "var-init"),
      a = cc11001100_hook("a", n.attr("type"), "var-init"),
      s = cc11001100_hook("s", "layer-anim-close", "var-init");
    if (n[0]) {
      var f = cc11001100_hook("f", "layui-layer-wrap", "var-init"),
        c = function () {
          if (a === o.type[1] && "object" === n.attr("conType")) {
            n.children(":not(." + l[5] + ")").remove();
            for (var r = cc11001100_hook("r", n.find("." + f), "var-init"), s = cc11001100_hook("s", 0, "var-init"); s < 2; s++) r.unwrap();
            r.css("display", r.data("display")).removeClass(f);
          } else {
            if (a === o.type[2]) try {
              var c = cc11001100_hook("c", i("#" + l[4] + e)[0], "var-init");
              c.contentWindow.document.write(""), c.contentWindow.close(), n.find("." + l[5])[0].removeChild(c);
            } catch (u) {}
            n[0].innerHTML = cc11001100_hook("n[0].innerHTML", "", "assign"), n.remove();
          }
  ...
  }, "assign"), r.closeAll = cc11001100_hook("r.closeAll", function (e, t) {
    "function" == typeof e && (t = cc11001100_hook("t", e, "assign"), e = cc11001100_hook("e", null, "assign"));
    var n = cc11001100_hook("n", i("." + l[0]), "var-init");
    i.each(n, function (a) {
      var o = cc11001100_hook("o", i(this), "var-init"),
        s = cc11001100_hook("s", e ? o.attr("type") === e : 1, "var-init");
      s && r.close(o.attr("times"), a === n.length - 1 ? t : null), s = cc11001100_hook("s", null, "assign");
  ...
  r.prompt = cc11001100_hook("r.prompt", function (e, t) {
    ...
    var s,
      l = cc11001100_hook("l", 2 == e.formType ? '<textarea class="layui-layer-input"' + a + "></textarea>" : function () {
    ...
    return delete e.success, r.open(i.extend({
      ...
      success: function (t) {
        s = cc11001100_hook("s", t.find(".layui-layer-input"), "assign"), s.val(e.value || "").focus(), "function" == typeof f && f(t);
      },
      resize: cc11001100_hook("resize", !1, "object-key-init"),
      yes: function (i) {
    ...
    if (t = cc11001100_hook("t", t || {}, "assign"), t.photos) {
      var l = cc11001100_hook("l", !("string" == typeof t.photos || t.photos instanceof i), "var-init"),
      ...
      s.imgprev = cc11001100_hook("s.imgprev", function (e) {
        ...
        r.close(s.loadi), a && (t.anim = cc11001100_hook("t.anim", -1, "assign")), s.index = cc11001100_hook("s.index", r.open(i.extend({
          type: cc11001100_hook("type", 1, "object-key-init"),
          ...
          anim: cc11001100_hook("anim", 5, "object-key-init"),
          ...
          content: cc11001100_hook("content", '<div class="layui-layer-phimg"><img src="' + u[d].src + '" alt="' + (u[d].alt || "") + '" layer-pid="' + u[d].pid + '">' + function () {
          ...
          success: function (e, i) {
            s.bigimg = cc11001100_hook("s.bigimg", e.find(".layui-layer-phimg"), "assign"), s.imgsee = cc11001100_hook("s.imgsee", e.find(".layui-layer-imgbar"), "assign"), s.event(e), t.tab && t.tab(u[d], e), "function" == typeof y && y(e);
          },
          end: function () {
